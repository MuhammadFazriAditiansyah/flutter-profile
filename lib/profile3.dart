          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children: const [
                  Text("@nadia_uiux", style: TextStyle(color: Colors.grey)),
                  SizedBox(width: 8),
              ...
              Padding(
                ...
                child: Card(
                  ...
                  child: const Padding(
                    ...
                    child: Text(
                      "BIO\nSaya adalah seorang UI/UX Designer yang berfokus pada "
                      "pembuatan desain antarmuka yang menarik, sederhana, dan mudah digunakan. "
                      "Saya percaya bahwa desain yang baik dapat meningkatkan pengalaman pengguna "
                      "dan membantu aplikasi menjadi lebih bermanfaat.",
                      style: TextStyle(color: Colors.white),
